...
class _HomePageState extends State<HomePage> {
  // 1st
  List<CategoriesModle> burgerList = []; //frm provider,get category
  ...
  List<FoodCategoriesModle> burgerCategoriesList = []; //item in category
  ...
  Widget drawerItem({@required String name, @required IconData icon}) { //ui
    return ListTile(
      leading: Icon(
        icon,
        color: Colors.white,
  ...
  Widget burger() {
    return Row(
      children: burgerList
          .map((e) => categoriesContainer( //ui
              image: e.image,         //frm provide element, category
              name: e.name,
              onTap: () {
                Navigator.of(context).pushReplacement(
                  MaterialPageRoute(
                    builder: (context) => Categories( //sigle product
                      list: burgerCategoriesList,  //item in category
                    ),
                  ),
                );
              }))
    ...
    return Scaffold(
          ...
          child: SafeArea(
            child: Column(
              ...
              children: [
                UserAccountsDrawerHeader(
                  decoration: BoxDecoration(
                    image: DecorationImage(
                      fit: BoxFit.cover,
                      image: AssetImage('images/background.jpg'), //put file image to interface
                    ),
                  ),
                ...
                drawerItem(icon: Icons.person, name: "Profile"), //ui
      ...
      body: Column(                    
        ...
        children: [
          ...
          SingleChildScrollView( //categoriew
