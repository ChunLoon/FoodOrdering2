...
class MyProvider extends ChangeNotifier {
  ...
  Future<void> getBurgerCategory() async {
    ...
    QuerySnapshot querySnapshot = await FirebaseFirestore.instance
        ...
        .doc('XhXjlgjk2ffXtCnAD1Ms') //tetap document id
        .collection('Burger')
        .get();
    ...
    querySnapshot.docs.forEach((element) {
      ...
      burgerModle = CategoriesModle.fromDocument(element);//save
  ...
  Future<void> getRecipeCategory() async {
    ...
    /*  recipeModle = CategoriesModle(
      ...
      recipeModle = CategoriesModle.fromDocument(element);
  ...
  Future<void> getPizzaCategory() async {
   ...
   /*   pizzaModle = CategoriesModle(
      ...
      pizzaModle = CategoriesModle.fromDocument(element);
...
/////////////////4th category /////////////
  ...
  Future<void> getDrinkCategory() async {
    ...
    querySnapshot.docs.forEach((element) {
     ...
     drinkModle = CategoriesModle.fromDocument(element);
    ...
    querySnapshot.docs.forEach(
      (element) {
       /* foodModle = FoodModle(
        ...
        foodModle = FoodModle.fromDocument(element);
  ...
  Future<void> getBurgerCategoriesList() async {
    ...
    /*  burgerCategoriesModle = FoodCategoriesModle(
        ...
        price: element.data()['price'],
              ...
              burgerCategoriesModle = FoodCategoriesModle.fromDocument(element);
  ...
  Future<void> getrecipeCategoriesList() async {
    ...
    /*  recipeCategoriesModle = FoodCategoriesModle(
        ...
        recipeCategoriesModle  = FoodCategoriesModle.fromDocument(element);
  ...
  Future<void> getPizzaCategoriesList() async {
    ...
    querySnapshot.docs.forEach((element) {
      ...
      pizzaCategoriesModle   = FoodCategoriesModle.fromDocument(element);
  ...
  Future<void> getDrinkCategoriesList() async {
    ...
    querySnapshot.docs.forEach((element) {
      ...
      drinkCategoriesModle  = FoodCategoriesModle.fromDocument(element);
